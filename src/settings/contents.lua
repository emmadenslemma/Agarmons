  ...
  pages = {
    ...
    },
    {
      ...
      tiles = {
        ...
        { list = { "j_agar_cresselia" }, label = function() return localize { type = "name_text", set = "Joker", key = "j_agar_cresselia" } end, config_key = "cresselia" },
        ...
        { list = { "j_agar_diancie" }, label = function() return localize { type = "name_text", set = "Joker", key = "j_agar_diancie" } end, config_key = "diancie" },

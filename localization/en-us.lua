    ...
    descriptions = {
        Joker = {
            ...
            j_agar_cosmoem = {
                name = "Cosmoem",
                text = {
                    "{C:inactive,s:0.8}(Evolves when scoring {C:attention,s:0.8}#1# {C:hearts,s:0.8}#2#{} cards)",
                    "{C:inactive,s:0.8}(Evolves when scoring {C:attention,s:0.8}#2# {C:clubs,s:0.8}#4#{} cards)",
                }
            },

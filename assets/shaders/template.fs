// Template file for making your own card shaders
...
// Optionally to use `self.ARGS.send_to_shader`:
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    tex.rbg = tex.rbg / center_dist; // The closer to the center, the brighter the effect

    // Required for the dissolve effect to work on your shader
